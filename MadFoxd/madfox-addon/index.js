...
function captureTabs(closeTabs){
    var i = 0;
    console.error("Profile dir = " + getProfileName());
    var dirname = "/tmp/madfox." + env.USER + "__" + getProfileName();
